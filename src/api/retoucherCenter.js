...
export function getRetouchStreams (params) {
  return axios({
    ...
    msg.data.forEach(listItem => {
      ...
      listItem.isCheckReturn = listItem.tags.statics && listItem.tags.statics.includes('rework') || false
      if (params.state === 'hanging') {
        ...
        if (listItem.tags.statics && listItem.tags.statics.includes('rework')) {
